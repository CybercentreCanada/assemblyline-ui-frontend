...
const Parameter = memo(({ customize, disabled, loading, param_id, spec_id }: ParameterProps) => {
  const form = useForm();
...
const Service = memo(({ cat_id, svr_id, customize, disabled, loading }: ServiceProps) => {
