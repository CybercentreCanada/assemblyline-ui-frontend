...
const StepIcon = memo(WrappedStepIcon);
...
const Progress = memo(WrappedProgress);
...
const WrappedSteppedPercentage = ({
  steps = [],
  loading = false,
  activeStep = 0,
  ...
  return steps && Array.isArray(steps) && steps.length >= 1 ? (
    <div style={{ width: '100%', display: 'flex', flexDirection: 'row', justifyItems: 'center' }}>
      <Item>
...
export const SteppedPercentage = memo(WrappedSteppedPercentage);

SteppedPercentage.displayName = 'SteppedPercentage';
