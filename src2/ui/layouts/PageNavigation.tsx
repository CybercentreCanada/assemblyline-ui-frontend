...
export const PageNavigationItem = memo((props: PageNavigationItemProp) => {
  const theme = useTheme();
  const isMobile = useMediaQuery(theme.breakpoints.down('lg'));
...
export type PageNavigationProps = Omit<ListProps, 'subheader'> & {
  ...
  renderItem?: (
    ...
    index: number,
    NavItem: (props: PageNavigationItemProp) => ReactNode
  ) => ReactNode;
...
export const PageNavigation = memo(
  ({
    ...
    const handleNavigate = useCallback(
      (e: MouseEvent<HTMLElement>, p: PageNavigationItemProp) => {
        setOpen(false);
