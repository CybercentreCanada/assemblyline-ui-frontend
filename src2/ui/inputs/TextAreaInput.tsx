...
import type { InputTextFieldProps } from 'ui/inputs/components/inputs.component.textfield';
...
export type TextAreaInputProps = InputValueModel<string, ChangeEvent<HTMLTextAreaElement | HTMLInputElement>> &
  InputOptions &
  InputSlotProps & {
