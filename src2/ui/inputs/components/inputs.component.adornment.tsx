...
export const ClearInputAdornment = memo(({ variant = 'icon' }: InputButtonAdornmentProps) => {
...
export const ExpandInputAdornment = memo(({ variant = 'icon' }: InputButtonAdornmentProps) => {
  const { t } = useTranslation('inputs');
  const theme = useTheme();
...
export const HelpInputAdornment = memo(({ variant = 'icon' }: InputButtonAdornmentProps) => {
  const { t } = useTranslation('inputs');
  const theme = useTheme();
...
export const MenuInputAdornment = memo(({ variant = 'icon' }: InputButtonAdornmentProps) => {
  const { t } = useTranslation('inputs');
  const theme = useTheme();
...
export const PasswordInputAdornment = memo(({ variant = 'icon' }: InputButtonAdornmentProps) => {
  const { t } = useTranslation('inputs');
  const theme = useTheme();
...
export const ProgressInputAdornment = memo(() => {
  const theme = useTheme();
...
export const ResetInputAdornment = memo(({ variant = 'icon' }: InputButtonAdornmentProps) => {
  const { t } = useTranslation('inputs');
  const theme = useTheme();
...
export const InputButtonEndAdornment = memo(
...
export const InputEndAdornment = memo(
  ({ children, preventRender = true, ...props }: Partial<InputAdornmentProps> & { preventRender?: boolean }) => {
    const theme = useTheme();
