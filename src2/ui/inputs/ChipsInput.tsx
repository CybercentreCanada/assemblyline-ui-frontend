...
import { InputCustomChip, InputTextField } from 'ui/inputs/components/inputs.component.textfield';
...
export type ChipsInputProps = InputValueModel<string[], SyntheticEvent<Element, Event>> &
  InputOptions &
  InputSlotProps & {
                      ...
                      onKeyDown: (event: KeyboardEvent<HTMLInputElement>) => {
                        if (event.key === 'Enter') {
                          ...
                          if (current === '') {
                            ...
                            handleChange(event as unknown as SyntheticEvent, next);
                          }
                        }
                      }
                    })
