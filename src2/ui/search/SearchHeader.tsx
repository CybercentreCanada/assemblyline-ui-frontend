...
import type { CustomChipProps } from 'ui/chips/CustomChip';
import { CustomChip } from 'ui/chips/CustomChip';
import { PageContainer } from 'ui/pages/PageContainer';
import { SearchCount, TOTAL_TRACKED_RECORDS } from 'ui/search/SearchCount';
...
const PopoverChip = memo(WrappedPopoverChip);
...
export const SearchHeader = memo(WrappedSearchHeader);
