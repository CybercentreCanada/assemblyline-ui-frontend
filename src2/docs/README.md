...
> Architecture, design philosophy, and conventions for the frontend application.

## Reading Order

Start here if you're new to the codebase:

1. [Architecture Overview](./architecture.md) — System design, layers, data flow
...
Machine-readable architecture rules for AI coding assistants:

- [AI Docs Index](./ai/README.md) — How to configure your AI tool to use these rules
