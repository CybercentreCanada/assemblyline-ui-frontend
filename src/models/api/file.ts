...
import type { FileIndexed, File as FileInfo } from 'models/base/file';
import type { AlternateResult, FileResult, ResultIndexed } from 'models/base/result';
import type { Attack, Signature, Tag } from 'models/base/tagging';
