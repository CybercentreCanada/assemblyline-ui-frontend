...
const useMyAPI = (): UseMyAPIReturn => {
  ...
  const isAPIData = useCallback((value: any): boolean => {
    if (
      value !== undefined &&
      value !== null &&
  ...
  const bootstrap = useCallback(
    ...
    [closeSnackbar, isAPIData, showErrorMessage, t]
  );
  ...
  const apiCall = useCallback(
    ...
    [closeSnackbar, isAPIData, showErrorMessage, systemConfig.system.version, t]
  );
