...
import type { CompletionItem, IRange, Snippet } from 'components/routes/developer/api/utils/monaco';
import { CompletionItemInsertTextRule, CompletionItemKind } from 'components/routes/developer/api/utils/monaco';
