...
export const LayoutSection = React.memo(() => {
  ...
  return (
    <form.Subscribe
      selector={state => state.values.layout.open}
      children={open => (
        <PageSection
          primary="Layout"
          open={open}
          collapsible
          divider
          wrapperProps={{ style: { display: 'flex', flexDirection: 'column', rowGap: theme.spacing(5) } }}
          onChange={o => {
            form.setStore(s => {
              s.layout.open = o;
              return s;
        ...
        >
          <DemoSection
            ...
            left={
              <form.Subscribe
                selector={state => state.values.layout.values.classification}
                children={value => (
                  <PageHeader
                    primary="Page Header"
                ...
                children={value => (
                  <PageHeader
                    ...
                    onClassificationChange={next => {
                      form.setStore(s => {
                        s.layout.values.classification = next;
                        return s;
                      });
                    }}
                  />
...
>
  {children}
          ...
          <DemoSection
            ...
            left={
              <form.Subscribe
                selector={state => state.values.layout.values.sectionOpen}
                children={value => (
                  <PageSection
                    primary="Page Section"
                    secondary="Description of the Page Section"
                    ...
                    onChange={next => {
                      form.setStore(s => {
                        s.layout.values.sectionOpen = next;
                        return s;
                      });
                    }}
                  >
