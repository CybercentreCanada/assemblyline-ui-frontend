...
export const ListInputsSection = React.memo(() => {
  ...
  return (
    <form.Subscribe
      selector={state => state.values.listinputs.open}
      children={open => (
        <PageSection
          primary="List Inputs"
          open={open}
          ...
          <DemoSection
            ...
            left={
              <div>
                ...
                <List>
                  <form.Subscribe
                    selector={state => state.values.listinputs.values.text}
                    children={value => (
                      <TextListInput
                  ...
                  <form.Subscribe
                    selector={state => state.values.listinputs.values.number}
                    children={value => (
                      <NumberListInput
                        ...
                        onChange={(event, next) => {
                          form.setStore(s => {
                            s.listinputs.values.number = next;
                            return s;
                          });
                        }}
                      />
                  ...
                  <form.Subscribe
                    selector={state => state.values.listinputs.values.select}
                    children={value => (
                      <SelectListInput
                        ...
                        onChange={(event, next) => {
                          form.setStore(s => {
                            s.listinputs.values.select = next;
                            return s;
                          });
                        }}
                      />
                  ...
                  <form.Subscribe
                    selector={state => state.values.listinputs.values.classification}
                    children={value => (
                      <ClassificationListInput
                        ...
                        onChange={next => {
                          form.setStore(s => {
                            s.listinputs.values.classification = next;
                            return s;
                          });
                        }}
                      />
                  ...
                  <form.Subscribe
                    selector={state => state.values.listinputs.values.boolean}
                    children={value => (
                      <BooleanListInput
                        ...
                        onChange={(event, next) => {
                          form.setStore(s => {
                            s.listinputs.values.boolean = next;
                            return s;
                          });
                        }}
                      />
                  ...
                  <form.Subscribe
                    ...
                    children={value => (
                      <ClassificationListInput
                        ...
                        onReset={() => {
                          form.setStore(s => {
                            s.listinputs.values.classification = 'TLP:C';
                            return s;
                          });
                        }}
                      />
                  ...
                  <form.Subscribe
                    ...
                    children={value => (
                      <BooleanListInput
                        ...
                        onReset={() => {
                          form.setStore(s => {
                            s.listinputs.values.boolean = false;
                            return s;
                          });
                        }}
                      />
    ...
    />
          ...
          <DemoSection
            ...
            left={
              <form.Subscribe
                selector={state => [
                  state.values.listinputs.state.disabled,
                  state.values.listinputs.state.loading,
                  state.values.listinputs.state.reset,
                  state.values.listinputs.state.error,
                  state.values.listinputs.state.readOnly
                ]}
            ...
            right={
              <div style={{ display: 'flex', flexDirection: 'column', rowGap: theme.spacing(1) }}>
                <form.Subscribe
                  selector={state => state.values.listinputs.state.disabled}
                  children={value => (
                    <CheckboxInput
                      label="Disabled"
                      value={value}
                      onChange={(event, next) => {
                        form.setStore(s => {
                          s.listinputs.state.disabled = next;
                          return s;
                        });
                      }}
                    />
                ...
                <form.Subscribe
                  selector={state => state.values.listinputs.state.loading}
                  children={value => (
                    <CheckboxInput
                      label="Loading"
                      value={value}
                      onChange={(event, next) => {
                        form.setStore(s => {
                          s.listinputs.state.loading = next;
                          return s;
                        });
                      }}
                    />
                ...
                <form.Subscribe
                  selector={state => state.values.listinputs.state.reset}
                  children={value => (
                    <CheckboxInput
                      label="Reset"
                      value={value}
                ...
                <form.Subscribe
                  selector={state => state.values.listinputs.state.error}
                  children={value => (
                    <CheckboxInput
                      label="Error"
                      value={value}
                ...
                <form.Subscribe
                  selector={state => state.values.listinputs.state.readOnly}
                  children={value => (
                    <CheckboxInput
                      label="ReadOnly"
                      value={value}
                      onChange={(event, next) => {
                        form.setStore(s => {
                          s.listinputs.state.readOnly = next;
                          return s;
                        });
                      }}
                    />
