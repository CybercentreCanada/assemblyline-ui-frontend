import type { NestedTypeUsingTuplesAgain2, ValidPathTuples } from 'components/routes/submit2/utils/JSONPath';
import { getValueFromPath, setValueFromPath } from 'components/routes/submit2/utils/JSONPath';
