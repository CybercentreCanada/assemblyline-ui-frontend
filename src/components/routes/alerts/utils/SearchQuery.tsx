export default class SearchQuery {
  ...
  private defaults: URLSearchParams = null;

  constructor(baseSearch: string, defaultSearch: string = 'rows=25&offset=0') {
    this.params = new URLSearchParams(baseSearch);
    this.defaults = new URLSearchParams(defaultSearch);
  }
  ...
  public getDeltaString() {
    ...
    this.params.forEach((value, key) => {
      if (this.defaults.get(key) !== value) {
