      ...
      <div style={{ textAlign: 'left' }}>
        ...
        <Grid container spacing={2} height="100vh">
          ...
          <Grid item xs={12}>
            ...
            {retrohunt ? (
              ...
              //   margin="dense"
              //   variant="outlined"
              //   onChange={e => handleValueChange(e, 'classification')}
                  ...
                  {retrohunt !== null ? (
                    <>
                      <Editor
                        ...
                        onChange={value => setRetrohunt(r => ({ ...r, yara_signature: value }))}
                        beforeMount={beforeMount}
                        onMount={onMount}
                        options={{ links: false }}
                      />
        ...
        <div style={{ textAlign: 'center', paddingTop: theme.spacing(3) }}>
          ...
          {retrohunt ? (
            retrohunt.edited_by && (
              <Typography variant="subtitle2" color="textSecondary">
                {`${t('edited_by')} ${retrohunt.edited_by} `}
                <Moment fromNow locale={i18n.language}>
                  {retrohunt.last_edit}
                </Moment>
              </Typography>
