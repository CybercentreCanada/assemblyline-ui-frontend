...
const BadlistSearch = () => {
  ...
  const handleReload = useCallback(
    (body: BadlistParams) => {
      if (!search || !currentUser.roles.includes('badlist_view')) return;
...
const WrappedBadlistPage = () => (
  <SearchParamsProvider defaultValue={BADLIST_PARAMS} hidden={['rows', 'offset']} enforced={['rows']}>
    <BadlistSearch />
