      ...
      <>
        ...
        <TabContext value={tabContext}>
          <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
            <TabList onChange={(_, value) => setTabContext(value)} aria-label="netowrk configuration" centered>
              <Tab
                label={t('general')}
                icon={
              ...
              <Grid item xs={6}>
                <FormControlLabel
                  ...
                  label={
                    <Typography variant="body2">
                      {t('ignore_ssl')}
                      <ResetButton service={source} defaults={defaults} field="ssl_ignore_errors" reset={resetField} />
                    </Typography>
                  }
                  className={classes.checkbox}
                />
