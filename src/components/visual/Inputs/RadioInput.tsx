...
type Options = (Omit<FormControlLabelProps, 'control'> & { control?: FormControlLabelProps['control'] })[];

export type RadioInputProps<O extends Options> = {
  label: string;
...
const WrappedRadioInput = <O extends Options = []>({
  disabled,
  endAdornment = null,
  error = () => null,
  errorProps = null,
