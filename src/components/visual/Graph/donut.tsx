...
const WrappedDoughnut = ({
  ...
  return histData ? (
    <div style={{ height: height }}>
      <ChartDoughnut
        data={{ labels: ['Red', 'Yellow', 'Green'], datasets: [{ label: '# number of votes', data: [12, 19, 3] }] }}
        // options={options}
        // plugins={plugins}
      />
    </div>
...
WrappedDoughnut.defaultProps = {
  title: null,
  height: null,
  isDate: false
};

export const Doughnut = React.memo(WrappedDoughnut);
