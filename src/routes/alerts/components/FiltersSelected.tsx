...
import type { Option } from 'routes/alerts/components/Filters';
import { GROUPBY_OPTIONS, SORT_OPTIONS, TC_OPTIONS } from 'routes/alerts/components/Filters';
...
const WrappedAlertFiltersSelected = ({
  ...
  const filters = useMemo<Filters>(() => {
    ...
    search.fq.forEach((filter: string) => {
