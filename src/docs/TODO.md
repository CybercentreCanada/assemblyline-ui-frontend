...
This file serves as an index for all task lists. Individual todo files are stored in `docs/todos/` and organized by concern.
...
- Add tasks to the relevant file
- Ask the LLM to verify implementation status against the codebase
- Mark items `[x]` when confirmed complete
