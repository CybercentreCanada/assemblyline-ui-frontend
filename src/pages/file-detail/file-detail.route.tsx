...
import AttackSection from 'pages/file-detail/components/attacks';
import ChildrenSection from 'pages/file-detail/components/childrens';
import Detection from 'pages/file-detail/components/detection';
import EmptySection from 'pages/file-detail/components/emptys';
import ErrorSection from 'pages/file-detail/components/errors';
import FrequencySection from 'pages/file-detail/components/frequency';
import IdentificationSection from 'pages/file-detail/components/ident';
import { default as MetadataSection } from 'pages/file-detail/components/metadata';
import ParentSection from 'pages/file-detail/components/parents';
