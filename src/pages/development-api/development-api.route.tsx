...
import type { Request, Response } from 'pages/development-api/development-api.models';
import {
  METHOD_COLOR_MAP,
  STATUS_CODES,
  formatMilliseconds,
  parseRequest,
  stringifyRequest
} from 'pages/development-api/development-api.utils';
...
export const DevelopmentAPIPage = memo(() => {
  ...
  const { data: routes, isLoading } = useAppQuery({ url: `/api/v4/` });
