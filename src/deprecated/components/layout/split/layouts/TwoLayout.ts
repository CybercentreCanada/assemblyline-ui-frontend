import type { LayoutComputer, LayoutState } from 'deprecated/components/layout/split/layouts/Layouts';
import { Layout } from 'deprecated/components/layout/split/layouts/Layouts';
...
export default class TwoLayout implements LayoutComputer {
  ...
  public constructor(
    ...
    public initLeftWidthPerc: number
  ) {}
