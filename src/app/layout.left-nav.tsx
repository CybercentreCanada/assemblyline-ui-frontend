    ...
    (): AppLeftNavItem[] => [
      {
        ...
        to: { create: { route: '/submit' } },
        icon: <PublishOutlinedIcon />
      },
      {
        id: 'submissions',
        label: t('drawer.submissions'),
        to: { create: { route: '/submissions' } },
      ...
      },
      {
        ...
        to: { create: { route: '/alerts_redirect' } },
              ...
              items: [
                {
                  ...
                  to: { create: { route: '/search' } },
                  icon: <Search />
                },
                {
                  id: 'search.alert',
                  label: t('drawer.search.alert'),
                  to: { create: { route: '/search/alert' } },
                  icon: <NotificationImportantOutlinedIcon />,
                  preventRender: !userRoles.includes('alert_view')
                },
                {
                ...
                },
                {
                  ...
                  to: { create: { route: '/search/retrohunt' } },
                  icon: <DataObjectOutlinedIcon />,
                  preventRender: !userRoles.includes('retrohunt_view') || !retrohuntEnabled
                },
                {
                  ...
                  to: { create: { route: '/search/signature' } },
                ...
                },
                {
                  ...
                  to: { create: { route: '/search/submission' } },
                  icon: <ViewCarouselOutlined />,
                  preventRender: !userRoles.includes('submission_view')
                }
              ]
              ...
              items: [
                {
                  ...
                  to: { create: { route: '/manage/badlist' } },
                ...
                },
                {
                  ...
                  to: { create: { route: '/manage/heuristics' } },
                ...
                },
                {
                  ...
                  to: { create: { route: '/manage/safelist' } },
                ...
                },
                {
                  ...
                  to: { create: { route: '/manage/signatures' } },
                  icon: <FingerprintOutlined />,
                  preventRender: !userRoles.includes('signature_view')
                },
                {
                  ...
                  to: { create: { route: '/manage/sources' } },
                  icon: <CodeOutlined />,
                ...
                },
                {
                  ...
                  to: { create: { route: '/manage/workflows' } },
                  icon: <BiNetworkChart />,
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            to: { create: { route: '/help/configuration' } },
            icon: <SettingsApplicationsOutlined />
          },
          {
            id: 'help.search',
            label: t('drawer.help.search'),
            to: { create: { route: '/help/search' } },
            icon: <Search />
          },
          {
            id: 'help.services',
            label: t('drawer.help.services'),
            to: { create: { route: '/help/services' } },
            icon: <AccountTreeOutlined />
          }
        ]
      },
