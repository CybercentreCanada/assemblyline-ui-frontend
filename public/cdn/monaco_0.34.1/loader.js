  ...
  var E = (function () {
    ...
    return (
      ...
      (p._isWindows = function () {
        return typeof navigator != 'undefined' && navigator.userAgent && navigator.userAgent.indexOf('Windows') >= 0
          ? !0
          : typeof process != 'undefined'
  ...
  var p = (function () {
    ...
    return (
      (a.prototype.record = function (n, v) {
        this._events.push(new E(n, v, l.Utilities.getHighPerformanceTimestamp()));
      }),
      ...
      (p.recursiveClone = function (g) {
        ...
        return (
          p.forEachProperty(g, function (n, v) {
            v && typeof v == 'object' ? (a[n] = p.recursiveClone(v)) : (a[n] = v);
          }),
          a
        );
      }),
      ...
      (p.getHighPerformanceTimestamp = function () {
        return (
          this.PERFORMANCE_NOW_PROBED ||
            ...
            (this.HAS_PERFORMANCE_NOW = l.global.performance && typeof l.global.performance.now == 'function')),
    ...
    return (
      (a.validateConfigurationOptions = function (n) {
        function v(e) {
          ...
          if (e.phase === 'factory') {
            console.error('The factory function of "' + e.moduleId + '" has thrown an exception'),
              console.error(e),
              console.error('Here are the modules that depend on it:'),
              console.error(e.neededBy);
            return;
        ...
        if (
          ...
          typeof n.buildForceInvokeFactory != 'object' && (n.buildForceInvokeFactory = {}),
          ...
          n.baseUrl.length > 0 && (l.Utilities.endsWith(n.baseUrl, '/') || (n.baseUrl += '/')),
          ...
          n.nodeCachedData &&
            ...
            (typeof n.nodeCachedData.writeDelay != 'number' || n.nodeCachedData.writeDelay < 0) &&
      ...
      (a.mergeConfigurationOptions = function (n, v) {
        ...
        return (
          l.Utilities.forEachProperty(n, function (e, t) {
            e === 'ignoreDuplicateModules' && typeof s.ignoreDuplicateModules != 'undefined'
    ...
    return (
      (a.prototype._createIgnoreDuplicateModulesMap = function () {
        ...
        for (var n = 0; n < this.options.ignoreDuplicateModules.length; n++)
          this.ignoreDuplicateModulesMap[this.options.ignoreDuplicateModules[n]] = !0;
      }),
      ...
      (a.prototype._applyPaths = function (n) {
        for (var v, s = 0, e = this.sortedPathsRules.length; s < e; s++)
          if (((v = this.sortedPathsRules[s]), l.Utilities.startsWith(n, v.from))) {
            for (var t = [], r = 0, o = v.to.length; r < o; r++) t.push(v.to[r] + n.substr(v.from.length));
            return t;
          }
        return [n];
      }),
      ...
      (a.prototype._addUrlArgsIfNecessaryToUrls = function (n) {
        if (this.options.urlArgs) for (var v = 0, s = n.length; v < s; v++) n[v] = this._addUrlArgsToUrl(n[v]);
        return n;
      }),
      (a.prototype.moduleIdToPaths = function (n) {
        if (this._env.isNode) {
          var v =
            ...
            (this.options.amdModulesPattern instanceof RegExp && !this.options.amdModulesPattern.test(n));
        ...
        if (!l.Utilities.endsWith(s, '.js') && !l.Utilities.isAbsolutePath(s)) {
          ...
          for (var t = 0, r = e.length; t < r; t++)
            (this.isBuild() && e[t] === 'empty:') ||
              (l.Utilities.isAbsolutePath(e[t]) || (e[t] = this.options.baseUrl + e[t]),
      ...
      (a.prototype.requireToUrl = function (n) {
        ...
        return (
          l.Utilities.isAbsolutePath(v) ||
            ((v = this._applyPaths(v)[0]), l.Utilities.isAbsolutePath(v) || (v = this.options.baseUrl + v)),
      ...
      (a.prototype.shouldInvokeFactory = function (n) {
        return this.options.isBuild ? this.options.buildForceInvokeFactory[n] || l.Utilities.isAnonymousModule(n) : !0;
      }),
        ...
        (e.prototype.load = function (t, r, o, i) {
          ...
          if (!this._scriptLoader)
            if (this._env.isWebWorker) this._scriptLoader = new a();
              ...
              f ? (this._scriptLoader = new p()) : (this._scriptLoader = new n(this._env));
            } else this._env.isNode ? (this._scriptLoader = new n(this._env)) : (this._scriptLoader = new p());
    ...
    p = (function () {
      ...
      return (
        (e.prototype.attachListeners = function (t, r, o) {
          var i = function () {
              t.removeEventListener('load', u), t.removeEventListener('error', f);
            },
            u = function (c) {
              i(), r();
            },
        ...
        (e.prototype.load = function (t, r, o, i) {
          if (/^node\|/.test(r)) {
            ...
            h.setAttribute('async', 'async'), h.setAttribute('type', 'text/javascript'), this.attachListeners(h, o, i);
            ...
            _ && h.setAttribute('nonce', _), document.getElementsByTagName('head')[0].appendChild(h);
          }
        }),
        e
      );
    ...
    n = (function () {
      ...
      return (
        ...
        (e.prototype._initNodeRequire = function (t, r) {
          ...
          u.prototype._compile = function (c, d) {
            ...
            try {
              ...
              (R = P.slice(0, 16)), (m.cachedData = P.slice(16)), y.record(60, _);
            } catch {
              y.record(61, _);
            }
            var b = new i._vm.Script(h, m),
              ...
              U = i._path.dirname(d),
              w = f(this),
              O = [this.exports, w, this, d, U, process, _commonjsGlobal, Buffer],
              C = I.apply(this.exports, O);
            return i._handleCachedData(b, h, _, !m.cachedData, r), i._verifyCachedData(b, h, _, R, r), C;
          };
        }),
        (e.prototype.load = function (t, r, o, i) {
          var u = this,
          ...
          if (/^node\|/.test(r)) {
            ...
            this._readSourceAndCachedData(m, b, h, function (I, U, w, O) {
              ...
              u._handleCachedData(N, C, b, P && !w, t), u._verifyCachedData(N, C, b, O, t);
            });
          }
        }),
        (e.prototype._createAndEvalScript = function (t, r, o, i, u) {
          ...
          return (
            (_.amd = h.amd),
            d.call(l.global, t.getGlobalAMDRequireFunc(), _, o.filename, this._path.dirname(o.filename)),
            f.record(32, o.filename),
            y ? i() : u(new Error("Didn't receive define call in " + o.filename + '!')),
            c
          );
        }),
        ...
        (e.prototype._handleCachedData = function (t, r, o, i, u) {
          ...
          t.cachedDataRejected
            ? this._fs.unlink(o, function (c) {
                u.getRecorder().record(62, o), f._createAndWriteCachedData(t, r, o, u), c && u.getConfig().onError(c);
              })
            : i && this._createAndWriteCachedData(t, r, o, u);
        }),
        (e.prototype._createAndWriteCachedData = function (t, r, o, i) {
          var u = this,
            f = Math.ceil(i.getConfig().getOptionsLiteral().nodeCachedData.writeDelay * (1 + Math.random())),
            c = -1,
            d = 0,
            h = void 0,
            y = function () {
              setTimeout(function () {
                h || (h = u._crypto.createHash('md5').update(r, 'utf8').digest());
                ...
                if (!(_.length === 0 || _.length === c || d >= 5)) {
                  ...
                  (c = _.length),
                    u._fs.writeFile(o, Buffer.concat([h, _]), function (m) {
                      m && i.getConfig().onError(m), i.getRecorder().record(63, o), y();
                    });
                }
              }, f * Math.pow(4, d++));
            };
          ...
          if (!r) this._fs.readFile(t, { encoding: 'utf8' }, i);
            ...
            this._fs.readFile(t, { encoding: 'utf8' }, function (y, _) {
              ...
              this._fs.readFile(r, function (y, _) {
                !y && _ && _.length > 0 ? ((c = _.slice(0, 16)), (f = _.slice(16)), o.record(60, r)) : o.record(61, r),
                  h();
              });
          }
        }),
            ...
            setTimeout(function () {
              ...
              i.equals(c) ||
                (u
                  .getConfig()
                  .onError(
                    new Error("FAILED TO VERIFY CACHED DATA, deleting stale '" + o + "' now, but a RESTART IS REQUIRED")
                  ),
      ...
      (s.prototype.resolveModule = function (e) {
        ...
        return (
          l.Utilities.isAbsolutePath(t) ||
            ((l.Utilities.startsWith(t, './') || l.Utilities.startsWith(t, '../')) &&
    ...
    return (
      ...
      (s.prototype.complete = function (e, t, r, o) {
        ...
        if (i) {
          ...
          (f.phase = 'factory'), (f.moduleId = this.strId), (f.neededBy = o(this.id)), (this.error = f), t.onError(f);
        }
  ...
  var g = (function () {
      ...
      return (
        ...
        (s.prototype.getModuleId = function (e) {
          ...
          return (
            typeof t == 'undefined' &&
              ((t = this._nextId++), this._strModuleIdToIntModuleId.set(e, t), (this._intModuleIdToStrModuleId[t] = e)),
            t
          );
        }),
    ...
    return (
        ...
        for (
          ...
          if (f) {
            ...
            if (((c = c.substr(y)), (c = r(c)), c === o)) {
              ...
              return _.line === 1 && (_.col -= '(function (require, define, __filename, __dirname) { '.length), _;
            }
          }
        }
        ...
        for (var e = [], t = 0, r = 0, o = this._modules2.length; r < o; r++) {
          ...
          if (!!i) {
            ...
            e[t++] = {
              id: i.strId,
              path: u,
              defineLocation: u && f ? s._findRelevantLocationInStack(u, f) : null,
              dependencies: c,
              shim: null,
              exports: i.exports
            };
        ...
        return (
          this._recorder ||
            (this._config.shouldRecordStats()
              ? (this._recorder = new l.LoaderEventRecorder(this._loaderAvailableTimestamp))
      ...
      (s.prototype.enqueueDefineAnonymousModule = function (e, t) {
        ...
        this._config.isBuild() && (r = new Error('StackLocation').stack || null),
          (this._currentAnonymousDefineCall = { stack: r, dependencies: e, callback: t });
      }),
      (s.prototype.defineModule = function (e, t, r, o, i, u) {
        ...
        (this._modules2[c] = d),
          this._config.isBuild() &&
            ...
            (this._buildInfoDependencies[c] = (d.dependencies || []).map(function (h) {
      ...
      (s.prototype._normalizeDependencies = function (e, t) {
        for (var r = [], o = 0, i = 0, u = e.length; i < u; i++) r[o++] = this._normalizeDependency(e[i], t);
        return r;
      }),
      (s.prototype._relativeRequire = function (e, t, r, o) {
        if (typeof t == 'string') return this.synchronousRequire(t, e);
        this.defineModule(l.Utilities.generateAnonymousModule(), t, r, o, null, e);
      }),
      ...
      (s.prototype.configure = function (e, t) {
        ...
        t ? (this._config = new l.Configuration(this._env, e)) : (this._config = this._config.cloneAndMerge(e)),
      ...
      (s.prototype._onLoadError = function (e, t) {
        ...
        this._modules2[e] ||
          (this._modules2[e] = new p(e, this._moduleIdProvider.getStrModuleId(e), [], function () {}, null, null));
        for (var o = [], i = 0, u = this._moduleIdProvider.getMaxModuleId(); i < u; i++) o[i] = !1;
        var f = !1,
          c = [];
      ...
      (s.prototype._loadModule = function (e) {
        ...
        if (!(this._modules2[e] || this._knownModules2[e])) {
          ...
          var r = this._moduleIdProvider.getStrModuleId(e),
            ...
            i = /^@[^\/]+\/[^\/]+$/;
          this._env.isNode && (r.indexOf('/') === -1 || i.test(r)) && o.push('node|' + r);
          var u = -1,
            f = function (c) {
              if ((u++, u >= o.length)) t._onLoadError(e, c);
                ...
                h.record(10, d),
                  t._scriptLoader.load(
                    ...
                    d,
                    function () {
                      t._config.isBuild() && (t._buildInfoPath[e] = d), h.record(11, d), t._onLoad(e);
                    },
                    function (y) {
                      h.record(12, d), f(y);
                    }
      ...
      (s.prototype._loadPluginDependency = function (e, t) {
        ...
        if (!(this._modules2[t.id] || this._knownModules2[t.id])) {
          ...
          var o = function (i) {
            r.defineModule(r._moduleIdProvider.getStrModuleId(t.id), [], i, null, null);
          };
          (o.error = function (i) {
...
`)
            ...
            if (
              ...
              h || ((h = []), this._inversePluginDependencies2.set(u.pluginId, h)),
                h.push(u),
        ...
        if (!e.isComplete()) {
          ...
          if (((this._inverseDependencies2[e.id] = null), y))
            for (var u = 0, f = y.length; u < f; u++) {
              var _ = y[u],
                m = this._modules2[_];
              m.unresolvedDependenciesCount--, m.unresolvedDependenciesCount === 0 && this._onModuleComplete(m);
            }
          var R = this._inversePluginDependencies2.get(e.id);
          if (R) {
            this._inversePluginDependencies2.delete(e.id);
            for (var u = 0, f = R.length; u < f; u++) this._loadPluginDependency(e.exports, R[u]);
          }
        }
      }),
      s
...
(function (l) {
  var E = new l.Environment(),
    ...
    g = function (s, e, t) {
      typeof s != 'string' && ((t = e), (e = s), (s = null)),
        ...
        s ? p.defineModule(s, e, t, null, null) : p.enqueueDefineAnonymousModule(e, t);
    };
  g.amd = { jQuery: !0 };
  var a = function (s, e) {
    ...
    n = function () {
      if (arguments.length === 1) {
        ...
        if (typeof arguments[0] == 'string') return p.synchronousRequire(arguments[0]);
      }
      if ((arguments.length === 2 || arguments.length === 3) && Array.isArray(arguments[0])) {
        p.defineModule(l.Utilities.generateAnonymousModule(), arguments[0], arguments[1], arguments[2], null);
        return;
      }
  ...
  (l.init = v),
    (typeof l.global.define != 'function' || !l.global.define.amd) &&
      ((p = new l.ModuleManager(E, l.createScriptLoader(E), g, n, l.Utilities.getHighPerformanceTimestamp())),
      typeof l.global.require != 'undefined' && typeof l.global.require != 'function' && n.config(l.global.require),
      (define = function () {
